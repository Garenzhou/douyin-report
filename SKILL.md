...
1. **增量下载**：自动检测已下载视频，避免重复下载
2. **主播管理**：配置要跟踪的主播列表
3. **语音转文字**：使用硅基流动 API 自动识别视频中的语音内容
4. **汇总报告**：生成 Markdown/HTML/JSON 三种格式的详细报告
5. **关键词提取**：自动分析视频内容，提取热门话题
...
# 或手动安装
pip install f2 pyyaml requests openai
```
